...
Scenario: User has a federal mortgage and a 14 day notice to quit
  ...
  And I set the "True" choice of var "facts.tenant_address_is_eviction_address" to "true" # Default missing in Español
  And I tap to continue
  ...
  When I set the "False" choice of var "tenant.name_different_on_summons" to "true" # Default missing in Español
  And I tap to continue
  ...
  When I set the var "landlord.is_new" to "false" # Default missing in Español
  And I tap to continue
  Then the question id should be "landlords attorney"
  When I set the "False" choice of var "landlord.has_attorney" to "true" # Default missing in Español
  When I tap to continue
  ...
  And I set the "True" choice of var "ntq_includes_tenant_name" to "true" # Default missing in Tiếng Việt
  And I set the "True" choice of var "ntq_includes_all_tenants" to "true" # Default missing in Tiếng Việt
  And I set the "True" choice of var "ntq_includes_correct_address" to "true" # Default missing in Tiếng Việt
  And I tap to continue
  Then the question id should be "nonpayment defenses"
  When I set the "True" choice of var "dont_owe_rent" to "true"  # Default missing in Tiếng Việt
  And I set the "True" choice of var "behind_in_rent" to "true"  # Default missing in Tiếng Việt
  And I tap to continue
  ...
  When I set the "True" choice of var "ntq_contains_reservation" to "true" # Default missing in Español
  When I tap to continue
...
#  When I tap to continue
#  Then the question id should be "landlord information"
#  When I set the "False" choice of var "landlord.is_new" to "true"
#  And I tap to continue
#  Then the question id should be "landlords attorney"
